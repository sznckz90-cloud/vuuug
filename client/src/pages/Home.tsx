  ...
  return (
    <Layout>
      <main className="max-w-md mx-auto px-4 pb-20">
        ...
        {!(user as User) && (
          <div className="mb-4 p-4 bg-blue-950/50 rounded-lg border border-blue-800">
            <div className="flex items-center gap-2 mb-2">
              <i className="fas fa-info-circle text-blue-400"></i>
              <h3 className="font-semibold text-blue-100 title-text">Telegram Mini App</h3>
            </div>
            ...
            {typeof window !== 'undefined' && window.Telegram?.WebApp ? (
              <button 
                ...
                className="w-full gradient-button tap-glow py-2.5 rounded-lg font-semibold"
              >
        ...
        {(user as User) && typeof window !== 'undefined' && !window.Telegram?.WebApp && window.location.hostname.includes('replit') && (
          <div className="mb-4 p-3 bg-yellow-950/50 rounded-lg border border-yellow-800">
            <div className="flex items-center gap-2">
              <i className="fas fa-flask text-yellow-400 text-sm"></i>
